...
//        var subsegment = AWSXRay.beginSubsegment("Search");
...
//                    .build();
//
//            var searchString = event.getQueryStringParameters().get("text");
...
//            subsegment.putAnnotation("searchString", searchString);
//            attributes.put(":user", AttributeValue.builder().s(getUserFromEvent(event)).build());
